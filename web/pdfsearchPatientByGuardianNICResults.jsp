    ...
    <body>
        ...
        <%
          try {
                    ...
                    List<String> allPatients = (List<String>) patientRepository.getPatientByGuardianNIC(id);
        ...
        <input type="hidden" name="id" value="<% String iddd = request.getParameter("patientid");
